...
export default function Hero() {
  ...
  return (
    ...
    // min-h-screen is the 100vh baseline; the dvh override stops mobile browser
    // chrome from cropping the hero.
    <section
      id="hero"
      className="relative isolate flex min-h-screen supports-[min-height:100dvh]:min-h-[100dvh] items-center overflow-hidden px-6 pt-24 pb-32 md:px-12 md:pb-28"
    >
